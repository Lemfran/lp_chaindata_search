...
# CSV文件基础保存路径
CSV_BASE_PATH = "/Users/fanjinchen/python/learn/transactions_data_PEPE_"  # 文件存储路径 /crypto_PEPE/data/transactions_data_PEPE_
# 状态日志文件路径
STATUS_LOG_FILE = "last_successful_transaction_PEPE.csv"
